package net.redmelon.fishandshiz.client;
...
public class BredFishAnimalsCriterion extends AbstractCriterion<BredAnimalsCriterion.Conditions> {
    ...
    public static class Conditions extends AbstractCriterionConditions {
        ...
        public static BredFishAnimalsCriterion.Conditions any() {
            return new BredFishAnimalsCriterion.Conditions(EntityPredicate.Extended.EMPTY, EntityPredicate.Extended.EMPTY, EntityPredicate.Extended.EMPTY, EntityPredicate.Extended.EMPTY);
        }

        public static BredFishAnimalsCriterion.Conditions create(EntityPredicate.Builder child) {
            return new BredFishAnimalsCriterion.Conditions(EntityPredicate.Extended.EMPTY, EntityPredicate.Extended.EMPTY, EntityPredicate.Extended.EMPTY, EntityPredicate.Extended.ofLegacy(child.build()));
        }

        public static BredFishAnimalsCriterion.Conditions create(EntityPredicate parent, EntityPredicate partner, EntityPredicate child) {
            return new BredFishAnimalsCriterion.Conditions(EntityPredicate.Extended.EMPTY, EntityPredicate.Extended.ofLegacy(parent), EntityPredicate.Extended.ofLegacy(partner), EntityPredicate.Extended.ofLegacy(child));
        }
